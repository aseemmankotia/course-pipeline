 ...
 * Reads API keys from localStorage key 'course_settings'.
 *
 * Usage:
...
(function () {
  ...
  function _getSettings() {
    try { return JSON.parse(localStorage.getItem('course_settings') || '{}'); }
    catch { return {}; }
  }
  ...
  async function callAI(opts) {
    ...
    try {
      ...
      if (err.isBalanceError) {
        ...
        // Non-balance, non-config Anthropic error — rethrow
        throw err;
      } else {
